...
PATTERN="1 2 3 4 5 6 7 8 9" # The unlock pattern to draw, space seperated

COL_1=234                   # X coordinate of column 1 (in pixels)
COL_2=538                   # X coordinate of column 2 (in pixels)
COL_3=842                   # X coordinate of column 3 (in pixels)

ROW_1=781                   # Y coordinate of row 1 (in pixels)
ROW_2=1085                  # Y coordinate of row 2 (in pixels)
ROW_3=1380                   # Y coordinate of row 3 (in pixels)
...
WAKE_SCREEN_ENABLED=false    # If true, the script will start by sending the power button press event
